...
object Main {
    ...
    fun main(args: Array<String>) {
        val bus1 = Bus(brand="BMW", num = 1,StartYear = 2019,probeg =  10000, name = " Жмышенко В.А.")
        val bus2 = Bus(brand="BMW",num =  2,StartYear =  2008,probeg =  13000,name =  " Детров П.А.")
        val bus3 = Bus(brand="VW", num = 2,StartYear =  2009, probeg = 1447, name =  " Версута А.З.")
        val bus4 = Bus(brand="MERCEDES", num = 4,StartYear = 2010,probeg = 9955,name =  " Дорнан С.И")
        val bus5 = Bus(brand="OPEL", num = 3,StartYear = 2012,probeg = 1212, name = " Осборн О.М.")
        val bus6 = Bus(brand="MERCEDES", num = 4,StartYear = 2007,probeg =  2229,name =  " Ельцин Б.Н.")
        val bus7 = Bus(brand="BMW", num = 1,StartYear =  2012,probeg =  1471,name =  " Ленин В.И.")
        val bus8 = Bus(brand="BMW", num = 3,StartYear =  2014,probeg =  9907,name =  " Летов Е.И.")
